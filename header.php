    ...
    <header
        ...
        <div class="sk-flex sk-items-center sk-gap-2 sk-text-primary-600 dark:sk-text-primary-400">
            <a href="<?php echo esc_url(home_url('/')); ?>" class="sk-flex sk-items-center sk-gap-2">
                ...
                <span class="sk-mt-1 sk-font-serif sk-text-3xl sk-leading-3"><?php bloginfo('name'); ?></span>
            </a>
        </div>
            ...
            <ul class="sk-flex sk-items-center sk-gap-6">
                ...
                <li>
                    <button @click="darkMode = !darkMode"
                            type="button"
                            class="sk-flex sk-items-center sk-justify-center sk-text-primary-600 hover:sk-opacity-80 focus:sk-outline-none dark:sk-text-primary-400"
